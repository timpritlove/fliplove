defmodule Fliplove.CLI.SymbolImporter do
  ...
  @symbol_size 16
  # Default border size around the image
  @default_border_size 8
  # Default distance between symbols
  @default_distance 8
  # Grayscale values above this are considered "white"
  @threshold 128
  ...
  ## Example
      ...
      iex> Fliplove.CLI.SymbolImporter.process_file("symbols.png", "output/bitmaps")
      :ok

      # With custom border and distance
      iex> Fliplove.CLI.SymbolImporter.process_file("symbols.png", "output/bitmaps", border: 10, distance: 6)
      :ok
  """
