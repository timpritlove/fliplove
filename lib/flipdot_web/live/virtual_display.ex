defmodule FlipdotWeb.VirtualDisplay do
  use GenServer
  ...
  def subscribe do
    Phoenix.PubSub.subscribe(Flipdot.PubSub, topic())
  end
  ...
  defp broadcast_update(bitmap) do
    Phoenix.PubSub.broadcast(Flipdot.PubSub, topic(), {:virtual_display_updated, bitmap})
  end
