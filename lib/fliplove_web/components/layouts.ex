defmodule FliploveWeb.Layouts do
  ...
  @doc """
  Application layout function component.

  This replaces the old app.html.heex template approach.
  All LiveView templates should wrap their content with this component.
  """
